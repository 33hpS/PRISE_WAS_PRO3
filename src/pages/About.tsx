          ...
          <div className='flex flex-wrap items-center justify-between gap-4'>
            <div className='min-w-0'>
              ...
              <p className='mt-2 text-gray-600'>
                Полнофункциональная система управления производством мебели с современным
                интерфейсом и продвинутыми возможностями.
              </p>
              <div className='mt-3 flex items-center gap-3 text-sm text-gray-500'>
                ...
                <span>
                  Статус: <span className='text-emerald-700 font-medium'>Готово к продакшену</span>
                </span>
              </div>
            </div>
      ...
      <Card className='bg-white border-gray-200'>
        ...
        <CardContent className='text-sm text-gray-700 space-y-2'>
          <ol className='list-decimal list-inside space-y-1'>
            ...
            <li>
              Build command:{' '}
              <code className='rounded bg-gray-100 px-1.5 py-0.5'>npm run build</code>
            </li>
            <li>
              Output directory: <code className='rounded bg-gray-100 px-1.5 py-0.5'>dist</code>
            </li>
            <li>
              Переменные окружения (опционально):{' '}
              <code className='rounded bg-gray-100 px-1.5 py-0.5'>NODE_ENV=production</code>,{' '}
              <code className='rounded bg-gray-100 px-1.5 py-0.5'>VITE_APP_VERSION=4.1.0</code>
            </li>
          </ol>
        </CardContent>
      </Card>
